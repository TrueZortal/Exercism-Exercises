...
class TriangleTest < Minitest::Test
  ...
  def test_degenerate_triangle
    ...
    assert triangle.degenerate?
  end

  def test_degenerate_triangle_with_floats
    triangle = Triangle.new([1.5,2.5,4])
    assert triangle.degenerate?
  end

  def test_large_degenerate_triangle
    triangle = Triangle.new([8,6,14])
    assert triangle.degenerate?
  end
end
