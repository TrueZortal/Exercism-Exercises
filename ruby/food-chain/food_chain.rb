class FoodChain
  def self.song
    ...
    all_them_animals.each_with_index do |animol, index|
      ...
      if index > 0
        all_the_swallowed_things << "She swallowed the #{animol[0]} to catch the #{previous_animol[0] == 'spider' ? previous_animol[0] + " that " + previous_animol[1][3, previous_animol[1].length-1] : previous_animol[0] + "."}\n"
