defmodule KitchenCalculator do
  ...
  def from_milliliter(volume_pair, _ = :milliliter), do: volume_pair
  def from_milliliter(volume_pair, _ = :cup), do: {:cup, (get_volume(volume_pair)/240)}
  def from_milliliter(volume_pair, _ = :fluid_ounce), do: {:fluid_ounce, (get_volume(volume_pair)/30)}
  def from_milliliter(volume_pair, _ = :teaspoon), do: {:teaspoon, (get_volume(volume_pair)/5)}
  def from_milliliter(volume_pair, _ = :tablespoon), do: {:tablespoon, (get_volume(volume_pair)/15)}
